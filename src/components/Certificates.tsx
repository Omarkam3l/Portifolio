          ...
          {certificatesData.map((cert) => (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2.5 pt-5 mt-5 border-t border-white/5">
                <button
                  onClick={() => setActivePreview(cert)}
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-sky-500/10 hover:bg-sky-500/20 text-sky-400 border border-sky-500/20 hover:border-sky-500/40 text-xs font-mono font-medium transition-all"
                >
                  <Eye className="w-3.5 h-3.5" />
                  <span>Preview</span>
                </button>
