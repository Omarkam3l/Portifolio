      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 space-y-12">
        ...
        <div className="space-y-6">
          {education.map((item) => (
            ...
            >
              {/* Header row: Icon, Institution, Degree, Date */}
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-5">
                <div className="flex items-start gap-4 sm:gap-5">
                  {/* Magenta-purple gradient squircle with GraduationCap icon */}
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-fuchsia-500 to-pink-600 flex items-center justify-center text-white shadow-lg shadow-fuchsia-500/20 shrink-0">
              ...
              {/* Description */}
              <p className="mt-5 sm:mt-6 text-sm sm:text-base text-slate-300 leading-relaxed font-light pl-1 sm:pl-2">
                {item.description}
              </p>
            </div>
          ))}
